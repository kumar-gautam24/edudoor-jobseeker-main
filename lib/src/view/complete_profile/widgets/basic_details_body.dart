...
class BasicDetailsBody extends StatefulWidget {
  ...
  const BasicDetailsBody({super.key, this.onlyUpdate = false});
                    ...
                    onTap: () async {
                      ...
                      customImagePicker.openImagePicker(
                          ...
                          handleFinish: (file) {
                            ...
                            context.read<AuthenticationBloc>().add(AuthenticationUploadEvent(profilePicLink: file));
                          });
                    },
                    child: Stack(
                      ...
                      children: [
                        CircularAvatar(
                          urlToImage: _profilePicLink,
                          blurHash: _profilePicLinkBlurHash,
                          isActive: true,
                          size: 100.sp,
                          strokeSize: 5,
                          child: _image != null
                                  ...
                                  children: [
                                    ...
                                    BlocBuilder<AuthenticationBloc, AuthenticationState>(
                                      builder: (context, state) {
                                        if (state is AuthenticationStaticUpdatingState) {
                                          return Container(
                                            width: 100.sp,
                                            height: 100.sp,
