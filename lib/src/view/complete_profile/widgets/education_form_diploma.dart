...
class EducationDiplomaState extends StatefulWidget {
  final bool onlyUpdate;
  const EducationDiplomaState({super.key, required this.onlyUpdate});

  @override
  State<EducationDiplomaState> createState() => _EducationDiplomaState();
}

class _EducationDiplomaState extends State<EducationDiplomaState> {
  String? _degreeName;
  ...
  update() {
    ...
    _degreeName = jobseekerModel?.education?.diploma?.degreeName;
    _fieldOfStudy = jobseekerModel?.education?.diploma?.fieldOfStudy;
    _collegeUniversity = jobseekerModel?.education?.diploma?.collegeORuniversity;
    _degreeType = jobseekerModel?.education?.diploma?.degreeType;
    _lat = jobseekerModel?.education?.diploma?.lat;
    _lng = jobseekerModel?.education?.diploma?.lng;
    _passingYear = jobseekerModel?.education?.diploma?.passingYear?.toString();
    _percentage = jobseekerModel?.education?.diploma?.percentageORmarks?.toString();
    _locationController.text = jobseekerModel?.education?.diploma?.address ?? "";
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                            ...
                            Row(
                              children: [
                                if (_showDelete == true)
                                  TextButton(
                                    onPressed: () {
                                      showEducationDialog(context, 'Delete diploma dialog', 'Delete diploma Education Details', 'Are you sure you want to delete diploma Education Details?', () {
                        ...
                        ModalSearchbox(
                          label: 'Degree Name',
                          list: Options.DIPLOMA_DEGREE_NAME,
